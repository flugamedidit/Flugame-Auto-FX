...
export interface AppState { activeTab: Tab; queue: QueueItem[]; queueIndex: number; currentTime: number; duration: number; isPlaying: boolean; isMuted: boolean; imageModel: string; videoModel: string; characterRefs: CharacterRef[]; broll: BrollState; aimv: AIMVState; }
